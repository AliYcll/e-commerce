    ...
    return (
        <div className="font-sans">
            ...
            <section className="container mx-auto px-4 py-12 text-center">
                <h5 className="font-bold text-text-gray mb-4">PRICING</h5>
                <h1 className="text-5xl font-bold text-primary mb-6">Simple Pricing</h1>
            ...
            <section className="bg-light-bg py-16">
                <div className="container mx-auto px-4 flex flex-col items-center">
                    ...
                    <div className="flex items-center gap-4 mb-16">
                        ...
                        >
                            <div className={`absolute top-1 w-4 h-4 rounded-full bg-[#E7E7E7] shadow-md transition-all duration-300 ${isYearly ? 'left-7 bg-secondary' : 'left-1'}`}></div>
                        </div>
            ...
            <section className="bg-light-bg pb-20">
                <div className="container mx-auto px-4 text-center">
                    <p className="text-text-gray text-xl mb-8">Trusted By Over 4000 Big Companies</p>
                    <div className="flex flex-wrap justify-between items-center gap-8 grayscale opacity-70 px-12">
                        ...
                        <span className="text-3xl font-bold">alien</span>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-white py-20 text-center">
                ...
                <div className="flex justify-center gap-6 mt-8 p-4">
                    <span className="text-3xl text-primary">T</span>
                    <span className="text-3xl text-primary">F</span>
                    <span className="text-3xl text-primary">I</span>
                    <span className="text-3xl text-primary">L</span>
                </div>
            </section>
